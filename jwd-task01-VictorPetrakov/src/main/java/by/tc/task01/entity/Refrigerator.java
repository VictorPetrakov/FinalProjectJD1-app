...
public class Refrigerator extends Appliance{
	...
	public Refrigerator(String name, String powerConsumption, String weight, String freezerCapacity, String overallCapacity, String height, String width) {
		super(name);
	...
	public String toString() {
		return getName() + "[powerConsumption=" + powerConsumption + ", weight=" + weight + ", freezerCapacity="
